...
namespace app.Data.EF.Migrations
{
    ...
    [Migration("20260509162646_CreatePayrollTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("app.Data.EF.Entities.Payroll", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<decimal>("KpiAmount")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(12, 2)
                        .HasColumnType("decimal(12,2)")
                        .HasDefaultValue(0m)
                        .HasColumnName("kpi_amount");
                    ...
                    b.Property<long?>("SalaryConfigId")
                        .HasColumnType("bigint")
                        .HasColumnName("salary_config_id");
                    ...
                    b.Property<decimal>("TeachingAmount")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(12, 2)
                        .HasColumnType("decimal(12,2)")
                        .HasDefaultValue(0m)
                        .HasColumnName("teaching_amount");
            ...
            modelBuilder.Entity("app.Data.EF.Entities.PayrollItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("app.Data.EF.Entities.SalaryConfig", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<decimal>("ConvertedLeadRate")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(12, 2)
                        .HasColumnType("decimal(12,2)")
                        .HasDefaultValue(0m)
                        .HasColumnName("converted_lead_rate");
                    ...
                    b.Property<sbyte>("SalaryType")
                        .HasColumnType("tinyint")
                        .HasColumnName("salary_type");

                    b.Property<decimal>("TeachingRate")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(12, 2)
                        .HasColumnType("decimal(12,2)")
                        .HasDefaultValue(0m)
                        .HasColumnName("teaching_rate");
                    ...
                    b.ToTable("salary_configs", (string)null);
                });
            ...
            modelBuilder.Entity("app.Data.EF.Entities.StaffKpiRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("staff_kpi_records", (string)null);
                });
            ...
            modelBuilder.Entity("app.Data.EF.Entities.Payroll", b =>
                {
                    ...
                    b.HasOne("app.Data.EF.Entities.SalaryConfig", null)
                        .WithMany()
            ...
            modelBuilder.Entity("app.Data.EF.Entities.PayrollItem", b =>
                {
                    b.HasOne("app.Data.EF.Entities.Payroll", null)
                        .WithMany()
